...
namespace ML.Link_0A
{
    ...
    public sealed class StatsRecorder
    {
        ...
        {
            m_Channel = new Stats.StatsSideChannel();
    ...
    {
        internal void AddStat(string key, float value, StatAggregationMethod aggregationMethod)
        {
            throw new NotImplementedException();
        }

        internal class StatsSideChannel : Stats
        {
        }
    }
}
