...
namespace ML.Link_0A
{
    ...
    internal class m_SensorShapeValidator
    {
        internal static void ValidateSensors(List<ISensor> sensors)
        {
            throw new NotImplementedException();
        }
    }

    internal class TensorUtils
    {
        internal static TensorProxy TensorProxyFromBarracuda(Tensor output, string n)
        {
            throw new NotImplementedException();
        }
    }
    ...
    {
        internal static IReadOnlyList<TensorProxy> GetInputTensors(Model barracudaModel)
        {
            throw new NotImplementedException();
        }

        internal static string[] GetOutputNames(Model barracudaModel)
        {
            throw new NotImplementedException();
        }
    }
    ...
    {
        private int seed;
        private ITensorAllocator tensorAllocator;
        private Dictionary<int, List<float>> memories;
        private Model barracudaModel;

        public TensorGenerator(int seed, ITensorAllocator tensorAllocator, Dictionary<int, List<float>> memories, Model barracudaModel)
        {
            this.seed = seed;
            this.tensorAllocator = tensorAllocator;
            this.memories = memories;
            this.barracudaModel = barracudaModel;
        }

        internal void GenerateTensors(IReadOnlyList<TensorProxy> m_InferenceInputs, int currentBatchSize, List<AgentInfoSensorsPair> m_Infos)
        {
            throw new NotImplementedException();
        }

        internal void InitializeObservations(List<ISensor> sensors, ITensorAllocator m_TensorAllocator)
        {
            throw new NotImplementedException();
        }
    }
