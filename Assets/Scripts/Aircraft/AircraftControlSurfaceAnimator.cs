...
namespace SkySync
{
    public class AircraftControlSurfaceAnimator : MonoBehaviour
    {
        ...
        private AircraftAgent m_Plane; // Reference to the aeroplane controller.


        private void Start()
        {
            // Get the reference to the aeroplane controller.
            m_Plane = GetComponent<AircraftAgent>();
                    ...
                    case ControlSurface.Type.Aileron:
                        {
                            ...
                            Quaternion rotation = Quaternion.Euler(surface.amount * m_Plane.rollChange, 0f, 0f);
                    ...
                    case ControlSurface.Type.Elevator:
                        {
                            ...
                            Quaternion rotation = Quaternion.Euler(surface.amount * -m_Plane.pitchChange, 0f, 0f);
                            RotateSurface(surface, rotation);
                            break;
                        }
                    case ControlSurface.Type.Rudder:
                        {
                            ...
                            Quaternion rotation = Quaternion.Euler(0f, surface.amount * m_Plane.yawChange, 0f);
                            RotateSurface(surface, rotation);
                            break;
                        }
                    case ControlSurface.Type.RuddervatorPositive:
                        {
                            ...
                            float r = m_Plane.yawChange + m_Plane.pitchChange;
