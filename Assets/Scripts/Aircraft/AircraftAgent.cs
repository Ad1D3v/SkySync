...
namespace SkySync
{
    public class AircraftAgent : Agent
    {
        ...
        private AircraftController AController;
        ...
        public float yawChange = 0f;
        private float smoothYawChange = 0f;
        public float rollChange = 0f;
        ...
        public override void Initialize()
        {
            ...
            AController = GetComponent<AircraftController>();
